...
public class Option {
    ...
    public Option(int uid, Access access, boolean available, Integer min, Integer max, Integer stepSize,
    ...
    public String toString() {
        return new StringJoiner(", ", Option.class.getSimpleName() + "[", "]").add("uid=" + uid).add("access=" + access)
