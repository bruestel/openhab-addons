 ...
 */
@NonNullByDefault
public record Option(int uid, String key, ContentType contentType, @Nullable Number min, @Nullable Number max,
        @Nullable Number stepSize, @Nullable String defaultValue, @Nullable String initValue,
