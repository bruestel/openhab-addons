...
1. **Access the Console**: Open your browser and navigate to:  
   ...
   *(e.g., `http://192.168.178.100:8080/homeconnectdirect`)*
2. **Go to Appliance Profiles**: Open the **"Profiles"** menu item.
3. **Upload Profiles**: Click the **`Upload Profile`** button in the top-right corner.
...
These channels reflect the **current actual values** of the home appliance. They answer the question: *"What is the current state?"*
...
These channels describe the **capabilities and constraints** of the appliance. They answer the question: *"What is currently possible?"*
